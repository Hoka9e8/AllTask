...
namespace Codes
{
    public sealed class GameController : MonoBehaviour, IDisposable
    {
        ...
        private Referense _reference;
        private void Awake()
        {
            _interactiveObject = new ListExecuteObject();
            _reference = new Referense();
            ...
            foreach (var o in _interactiveObject)
            {
                ...
                {
                    badBonus.OnCaugthPlayerChange += CaugthPlayer;
                    badBonus.OnCaugthPlayerChange += _displayEndGame.GameOver;
                }
        ...
        private void CaugthPlayer(string value, Color args)
        {
